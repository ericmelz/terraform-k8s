...
echo ""
echo "Hosty deployments:"
echo "  - dev-weighter-net namespace: hosty-dev"
echo "  - weighter-org namespace: hosty-prod"
echo ""
echo "Test Hosty routing:"
echo "  From your laptop: ./scripts/test-hosty-routing.sh"
echo "=========================================="